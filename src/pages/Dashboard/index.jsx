...
const Dashboard = () => {
  ...
  const [balanceType, setBalanceType] = useState('todos')
            ...
            <div>
              ...
              <CardsListContent>
                  <TransactionNavigation>
                    ...
                    <div>
                      <Button onClick={() => setBalanceType('todos')}>Todos</Button>
                      <Button onClick={() => setBalanceType('entrada')}>Entradas</Button>
                      <Button onClick={() => setBalanceType('despesa')}>Despesas</Button>
                    </div>
                  </TransactionNavigation>
                  {transactions.length > 0 ? <CardsList balanceType={balanceType} /> : (
